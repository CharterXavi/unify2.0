    ...
    return (
        <div className="CodeDocs two-column">
            <div className="title">
                ...
                <p>
                    Our typography system is currently implemented using 'em' units, which is a relative font sizing property. These 'em' units are relative to the base font-size, so in our case we've
                    declared a base font-size of 17px, so each different font stye/type (headings, paragraphs, etc.) in our system is a multiple of this base font size.
                </p>
                <hr/>
            </div>
